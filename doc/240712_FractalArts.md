...
日記です．朝から凄い頭が重かったのですが，夜に元気になってきました．
ローレンツアトラクタ(1983年)を改造して，128x128ピクセル，4色縛りのバージョンを作ってみました．

### 2024-11-10

ボイド(Boids)シミュレーションをPyxelに移植してみました．
単に表示するだけであれば，簡単にできました．

### 2024-11-16

ボイド(Boids)シミュレーションを改造して，3D回転させてみました．
